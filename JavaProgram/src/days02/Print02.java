...
public class Print02 {
	...
	public static void main(String[] args) {
		// printf 안에서 %와 s,f,d 사이에 숫자 옵션을 넣어서 표시할 자리수를 조절 할 수 있습니다.
		
		// 정수의 자리조절
		// %와 d 사이에 숫자를 안쓴경우 : 표시할 데이터의 자리수 만큼만 확보한 후 출력합니다.
		System.out.printf("정수%d정수\n",1234);

		// %와 d사이에 숫자를 쓴경우 : 쓴 숫자 자리수만큼 확보한 후 출력합니다.
		// 만약 자리수가 모자르다면 자동으로 필요한만큼 자리를 추가
		// 만약 자리수가 남는다면 남는 자리는 공백으로 채웁니다.
		...
		System.out.printf("정수%10d정수\n",145);
		System.out.printf("정수%10d정수\n",12345);
		// 충분한 자리와 1의자리를 맞춰서(오른쪽 정렬) 출력하기 위해서 같은 숫자 옵션을 지정하여 사용하는게 보통
		...
		// 숫자 썼지만 자리가 모자른 경우 : 필요한 만큼 자동으로 자리 추가
		...
		// 실수의 자리수 조절
		// 숫자를 안쓴경우 : 소수점 위자리는 필요한 자리수만큼 자동확보, 소수점 아래는 6자리가 확보후 출력
		// 						  남는 소수점은 0으로 채움
		System.out.printf("실수%f실수\n",123.123);
		
		// 조절 숫자를 쓴경우
		// %10.2f : 정수의 자리와 소수점 아래 자리수를 한번에 표현한 예시
