...
public class CalendarClass02 {
	...
	public static void main(String[] args) {
		...
		date1.set(2015, 7, 15);
		// set : 원하는 특정 날짜로 객체내 날짜구성을 재설정, date2는 아직 오늘 날짜
		
		// set 메서드에 필드명과 값을 넣어주면 해당 필드값만 변경
		date2.set(Calendar.MONTH, 6);
		
		// 위 date1과 date2에 설정된 날짜를 "0000년 00월 00일 0요일"형식으로 출력해 주세요
		// System.out.println(); 안에 한번에 구성해서 출력해 주세요
	...
	private static void prn(Calendar date) {
