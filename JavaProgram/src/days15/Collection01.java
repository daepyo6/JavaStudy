...
// 1. 배열
// 	- 다수개의 요소를 저장할 수 있음, 번호에 의해 손쉬운 접근방법을 제공
// - 크기가 고정, 데이터의 중간사입과 중간삭제에 비효율적

// 2. 리스트(List)
// - 크기의 제약없이 데이터를 저장할 수 있음, 데이테의 삽입과 삭제에 최적화
// - 검색에 취약 : 참조값을 저장하기 때문에  -> 이를 개선하기 위한 더블링크드 리스트를 사용하기도 함
// - 데이터 저장 시 불필요한 메모리 사용
// 자바의 모든 자료구조 클래스(컬랙션 클래스)들은 java.util 패키지를 통해 제공받을 수 있음
...
// (검색을 위해서 사용, Key값은 중복을 허용하지 않음, Value값은 중복을 허용)
...
public class Collection01 {
	...
	public static void main(String[] args) {
		// 동적 배열의 객체 생성 초기값으로 크기를 지정할 수 있지만 통상적으로 크기 지정없이 사용
		Vector v = new Vector();
		ArrayList a = new ArrayList();
		
		// 데이터 입력 add 메서드를 이용하여 데이터를 입력
		v.add(10);
		v.add(20);
		v.add(30);
		...
		// 그래서 어떤 자료형의 객체이든 저장이 가능
		// 10, 20, 30은 객체가 아니지만 저장될때 Integer형으로 자동 변환됩니다.
